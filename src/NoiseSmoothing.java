...
public class NoiseSmoothing {
	...
	/***
	 * Returns a new array whose elements are a running average of adjacent
	 * elements of array
	 * 
	 * @param array
	 *            the sample signal values (to be averaged)
	 * @return double[] an array of length array.length-1 each of whose elements
	 *         is an adjacent pair of averaged elements from array
	 */
	...
	/***
	 * Returns a new array whose elements are a running average of 3 adjacent
	 * elements of array
	 * 
	 * @param array
	 *            the sample signal values (to be averaged)
	 * @return double[] an array of length array.length-2 each of whose elements
	 *         is 3 adjacent averaged elements from array
	 */
	...
	/***
	 * Returns a new array whose elements are each an average of n adjacent
	 * elements of array
	 * 
	 * @param array
	 *            the sample signal values (to be averaged)
	 * @return double[] an array, each of whose elements is the average of n
	 *         adjacent values from array
	 */
	...
	/***
	 * Return a randomly generated sample array of size size, whose values are
	 * mean +/- noiseAmount.
	 * 
	 * @param size
	 *            the size of the array
	 * @param mean
	 *            the mean value of all the numbers in the array
	 * @param noiseAmount
	 *            the magnitude of the maximum deviation from the mean of any
	 *            value.
